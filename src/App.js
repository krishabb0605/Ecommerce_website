  ...
  return (
      <div className='main'>
          <div className='header'>
            ...
            <sup className='sup_right' style={{ float: 'right' }}> {total}</sup>
          </div>
            <div className='container'>
              <div className='main-left'>

                  <div className='imgMain'>
                    <img src={selectedImage} alt='Product' className='img-main' onClick={openLightbox}/>
                  </div>
                  ...
                  <div className='imgChild'>
                    ...
                    <img
                        src={Image1}
                        alt='Product 1'
                        className={`img-child ${selectedImage === Image1 ? 'selected' : ''}`}
                        onClick={() => setLightboxIndex(0)}
                    />
                    <img
                        src={Image2}
                        alt='Product 2'
                        className={`img-child ${selectedImage === Image2 ? 'selected' : ''}`}
                        onClick={() => setLightboxIndex(1)}
                    />
                    <img
                        src={Image3}
                        alt='Product 3'
                        className={`img-child ${selectedImage === Image3 ? 'selected' : ''}`}
                        onClick={() => setLightboxIndex(2)}
                    />
                    <img
                        src={Image4}
                        alt='Product 4'
                        className={`img-child ${selectedImage === Image4 ? 'selected' : ''}`}
              ...
              <div className='main-right'>
                ...
                <h1 className='main_title'>Fall Limited Edition <br/> Sneakers</h1>
                <p className='para'>These low-profile sneakers are your perfect casual wear companion. Featuring a duable rubber outer sole. they'll withstand everything the weather can
                  offer.</p>

                <b>$125.00</b> <b className='perce'>50%</b><br/><br/>

                <b>
                  <strike className='strike'>$250.00</strike></b><br/><br/><br/><br/><br/>
                ...
                <span className='calc'> {count}</span>
        ...
        {lightboxOpen && (
            <div className='lightbox-overlay' onClick={closeLightbox}>
              <div className='lightbox-content' onClick={(e) => e.stopPropagation()}>
                ...
                <a className='lightbox-prev' onClick={() => navigateLightbox(-1)}> &#10094; </a>
                <img src={selectedImage} alt='Product' className='lightbox-img'/>
                <a className='lightbox-next' onClick={() => navigateLightbox(1)}> &#10095;  </a>
              </div>
            </div>
        )}
      </div>
